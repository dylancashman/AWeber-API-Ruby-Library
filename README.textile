...
The original gem stopped working for me around March 20, 2019.  I contacted Aweber Labs support and apparently "PUT" requests are no longer valid, and were replaced with "PATCH" commands.  In this fork, I just replace any "PUT"s with "PATCH"es.  

I've made it a pull request, but I don't believe this repo is being maintained anymore.  This fork is provided AS IS.
